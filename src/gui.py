...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.rad_is_standard_width = QtWidgets.QRadioButton(self.groupBox)
        self.rad_is_standard_width.setChecked(True)
        self.rad_is_standard_width.setObjectName("rad_is_standard_width")
        self.verticalLayout_2.addWidget(self.rad_is_standard_width)
        self.rad_is_wide_width = QtWidgets.QRadioButton(self.groupBox)
        ...
        self.horizontalLayout_4.addWidget(self.edt_results)

        self.retranslateUi(Dialog)
        QtCore.QMetaObject.connectSlotsByName(Dialog)
        Dialog.setTabOrder(self.cmb_width_size, self.cmb_gap)
        Dialog.setTabOrder(self.cmb_gap, self.cmb_thickness)
        Dialog.setTabOrder(self.cmb_thickness, self.edt_depth_channel)
        Dialog.setTabOrder(self.edt_depth_channel, self.cmb_height_size)
        Dialog.setTabOrder(self.cmb_height_size, self.edt_results)
        Dialog.setTabOrder(self.edt_results, self.btn_run)
